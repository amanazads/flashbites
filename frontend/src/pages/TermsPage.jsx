  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-2">FlashBites - Terms and Conditions</h1>
        ...
        <div className="space-y-8 text-gray-700">
          <section>
            ...
            <p className="mb-3">
              These Terms and Conditions ("Terms") govern your access to and use of the FlashBites website,
              mobile application, and related services (collectively, the "Platform"). By accessing, browsing,
              registering on, or using FlashBites in any manner, you agree to be legally bound by these Terms.
            </p>
            <p className="mb-3">
              FlashBites is a technology-based platform that facilitates online food ordering and delivery by
              connecting customers with independent restaurant partners and delivery partners. Please read these
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              including your name, phone number, address, payment details, and other account-related information, is accurate,
          ...
          <section>
            ...
            <p className="mb-3">
              You agree to notify FlashBites immediately in the event of any unauthorized use of your account,
              suspicious login activity, or security breach.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-3">
              All orders placed through FlashBites are subject to acceptance and confirmation by the respective restaurant partner.
            </p>
            <p className="mb-3">
              An order shall be deemed confirmed only after the restaurant partner accepts the order through the Platform.
            </p>
            <p className="mb-3">
            ...
            <p>
              In case of item unavailability, restaurant closure, operational issues, or technical failure,
              orders may be cancelled by the restaurant or the Platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              Payments may be made through online payment gateways, digital wallets, UPI, cards, net banking,
              or Cash on Delivery (COD), where available.
            </p>
            <p className="mb-3">
              By proceeding with payment, you authorize FlashBites and its authorized payment service providers
              to process the transaction on your behalf.
            </p>
            <p className="mb-3">
              FlashBites does not store complete payment card information and uses secure third-party payment
              processors for transaction handling.
            </p>
            <p className="mb-3">
              Cash on Delivery services may only be available in selected locations and are subject to operational feasibility.
            </p>
          ...
          <section>
            ...
            <p className="mb-3">
              Food quality issues, stale food, hygiene concerns, incorrect or missing items, and preparation-related complaints
              shall be the responsibility of the restaurant partner.
            </p>
            <p className="mb-3">
            ...
            <p className="mb-3">
              For Cash on Delivery orders, approved refunds may be credited to the user's wallet, bank account, UPI,
              or any other supported method.
            </p>
            <p className="mb-3">
              Refund requests arising due to customer errors, such as incorrect address, wrong item selection,
              duplicate order placement, or inability to receive the order, may not be eligible for refund.
            </p>
          ...
          <section>
            ...
            <p className="mb-3">
              Delivery times shown on the Platform are estimated and are provided for convenience only.
            </p>
            <p className="mb-3">
            ...
            <p className="mb-3">
              Where FlashBites manages delivery through its partner network, reasonable efforts will be made to ensure timely delivery.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-3">
              This includes, but is not limited to, placing fake orders, repeatedly cancelling confirmed orders,
              abusing the refund system, using bots or automated scripts, scraping data, harassing restaurant staff
              or delivery partners, or engaging in fraudulent payment activity.
            </p>
          ...
          <section>
            ...
            <p>
              The Platform reserves the right to block accounts, deny services, cancel orders, withhold refunds, and report
              activities to relevant authorities in cases involving suspected fraud, fake orders, payment abuse, repeated
              suspicious cancellations, identity misuse, or any conduct deemed harmful to the ecosystem.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              All food items listed on FlashBites are prepared, packaged, and sold by independent restaurant partners.
            </p>
            <p className="mb-3">
              Restaurants are solely responsible for food quality, hygiene standards, ingredient disclosure, allergen
              information, freshness, portion sizes, and compliance with applicable food safety laws, including FSSAI regulations.
            </p>
            <p className="mb-3">
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              incidental, consequential, special, punitive, or business-related damages arising out of the use of the Platform.
            </p>
            <p className="mb-3">
              This includes loss of profits, health reactions, allergic responses, delays, order issues, or technical disruptions.
            </p>
            <p>
              In all circumstances, FlashBites' maximum liability shall be limited to the total value of the order in question.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              User data shall be collected, processed, and stored solely for the purpose of providing services,
              including order processing, customer support, communication, fraud prevention, and operational improvement.
            </p>
            <p className="mb-3">FlashBites does not sell personal data to third parties.</p>
            <p>
              Data handling practices are further governed by the Privacy Policy, which forms an integral part of these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              All content on the Platform, including logos, branding, text, images, interface design, code,
              software architecture, and other materials, is the intellectual property of FlashBites unless otherwise stated.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-3">
              FlashBites reserves the right to suspend, restrict, or permanently terminate access to the Platform in cases involving
              fraud, abuse, violation of these Terms, legal compliance issues, or behavior harmful to the Platform ecosystem.
            </p>
          ...
          <section>
            ...
            <p className="mb-3">
              In the event of any dispute, users are encouraged to first contact FlashBites customer support for amicable resolution.
            </p>
            <p className="mb-3">If unresolved, disputes shall be referred to arbitration in accordance with the laws of India.</p>
            <p>
              The seat of arbitration shall be Lucknow, India, and proceedings shall be conducted in English.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Continued use of the Platform after such modifications shall constitute acceptance of the updated Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="mb-1 font-semibold">FlashBites</p>
              <p>
                Email:{' '}
